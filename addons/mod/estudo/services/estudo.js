...
.factory('$mmaModPage', function($mmFilepool, $mmSite, $mmFS, $http, $log, $q, $mmSitesManager, $mmUtil, mmaModPageComponent) {
    ...
    /**
     * Gets the estudo HTML.
     *
     * @module mm.addons.mod_estudo
     * @ngdoc method
     * @name $mmaModPage#getEstudoHtml
     * @param {Object} contents The module contents.
     * @param {Object} moduleId The module ID.
     * @return {Promise}
     */
    self.getEstudoHtml = function(contents, moduleId) {
        var indexUrl,
            paths = {},
            promise;
        ...
        angular.forEach(contents, function(content) {
            ...
            if (self._isMainPage(content)) {
                // This seems to be the most reliable way to spot the index estudo.
                indexUrl = url;
            } else {
        ...
        promise = (function() {
            ...
            if (!indexUrl) {
                ...
                $log.debug('Could not locate the index estudo');
                return $q.reject();
    ...
    /**
     * Returns whether the file is the main estudo of the module.
     *
     * @module mm.addons.mod_estudo
     * @ngdoc method
    ...
    self._isMainPage = function(file) {
        var filename = file.filename || undefined,
            ...
            url = '/mod_estudo/content/index.html',
    ...
    /**
     * Check if estudo plugin is enabled in a certain site.
     *
     * @module mm.addons.mod_estudo
     * @ngdoc method
    ...
    /**
     * Report a estudo as being viewed.
     *
     * @module mm.addons.mod_estudo
     * @ngdoc method
    ...
    self.logView = function(id) {
        if (id) {
            ...
            return $mmSite.write('mod_estudo_view_estudo', params);
        }
        return $q.reject();
    };
