...
.factory('$mmaModPage', function($mmFilepool, $mmSite, $mmFS, $http, $log, $q, $mmSitesManager, $mmUtil, mmaModPageComponent) {
    ...
    self.getPenseHtml = function(contents, moduleId) {
        ...
        angular.forEach(contents, function(content) {
            ...
            if (self._isMainPage(content)) {
                // This seems to be the most reliable way to spot the index pense.
                indexUrl = url;
            } else {
        ...
        promise = (function() {
            ...
            if (!indexUrl) {
                ...
                $log.debug('Could not locate the index pense');
                return $q.reject();
    ...
    /**
     * Returns whether the file is the main pense of the module.
     *
     * @module mm.addons.mod_pense
     * @ngdoc method
    ...
    self._isMainPage = function(file) {
        var filename = file.filename || undefined,
            ...
            url = '/mod_pense/content/index.html',
    ...
    /**
     * Check if pense plugin is enabled in a certain site.
     *
     * @module mm.addons.mod_pense
     * @ngdoc method
    ...
    /**
     * Report a pense as being viewed.
     *
     * @module mm.addons.mod_pense
     * @ngdoc method
    ...
    self.logView = function(id) {
        if (id) {
            ...
            return $mmSite.write('mod_pense_view_pense', params);
        }
        return $q.reject();
    };
