...
.factory('$mmaModPage', function($mmFilepool, $mmSite, $mmFS, $http, $log, $q, $mmSitesManager, $mmUtil, mmaModPageComponent) {
    ...
    /**
     * Gets the proposta HTML.
     *
     * @module mm.addons.mod_proposta
     * @ngdoc method
     * @name $mmaModPage#getPropostaHtml
     * @param {Object} contents The module contents.
     * @param {Object} moduleId The module ID.
     * @return {Promise}
     */
    self.getPropostaHtml = function(contents, moduleId) {
        var indexUrl,
            paths = {},
            promise;
        ...
        angular.forEach(contents, function(content) {
            ...
            if (self._isMainPage(content)) {
                // This seems to be the most reliable way to spot the index proposta.
                indexUrl = url;
            } else {
        ...
        promise = (function() {
            ...
            if (!indexUrl) {
                ...
                $log.debug('Could not locate the index proposta');
                return $q.reject();
    ...
    /**
     * Returns whether the file is the main proposta of the module.
     *
     * @module mm.addons.mod_proposta
     * @ngdoc method
    ...
    self._isMainPage = function(file) {
        var filename = file.filename || undefined,
            ...
            url = '/mod_proposta/content/index.html',
    ...
    /**
     * Check if proposta plugin is enabled in a certain site.
     *
     * @module mm.addons.mod_proposta
     * @ngdoc method
    ...
    /**
     * Report a proposta as being viewed.
     *
     * @module mm.addons.mod_proposta
     * @ngdoc method
    ...
    self.logView = function(id) {
        if (id) {
            ...
            return $mmSite.write('mod_proposta_view_proposta', params);
        }
        return $q.reject();
    };
