...
.factory('$mmaModPage', function($mmFilepool, $mmSite, $mmFS, $http, $log, $q, $mmSitesManager, $mmUtil, mmaModPageComponent) {
    ...
    self.getSaibaHtml = function(contents, moduleId) {
        ...
        angular.forEach(contents, function(content) {
            ...
            if (self._isMainPage(content)) {
                // This seems to be the most reliable way to spot the index saiba.
                indexUrl = url;
            } else {
        ...
        promise = (function() {
            ...
            if (!indexUrl) {
                ...
                $log.debug('Could not locate the index saiba');
                return $q.reject();
    ...
    /**
     * Returns whether the file is the main saiba of the module.
     *
     * @module mm.addons.mod_saiba
     * @ngdoc method
    ...
    self._isMainPage = function(file) {
        var filename = file.filename || undefined,
            ...
            url = '/mod_saiba/content/index.html',
    ...
    /**
     * Check if saiba plugin is enabled in a certain site.
     *
     * @module mm.addons.mod_saiba
     * @ngdoc method
    ...
    /**
     * Report a saiba as being viewed.
     *
     * @module mm.addons.mod_saiba
     * @ngdoc method
    ...
    self.logView = function(id) {
        if (id) {
            ...
            return $mmSite.write('mod_saiba_view_saiba', params);
        }
        return $q.reject();
    };
