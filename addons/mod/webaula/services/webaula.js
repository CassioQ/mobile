...
.factory('$mmaModPage', function($mmFilepool, $mmSite, $mmFS, $http, $log, $q, $mmSitesManager, $mmUtil, mmaModPageComponent) {
    ...
    /**
     * Gets the webaula HTML.
     *
     * @module mm.addons.mod_webaula
     * @ngdoc method
     * @name $mmaModPage#getWebaulaHtml
     * @param {Object} contents The module contents.
     * @param {Object} moduleId The module ID.
     * @return {Promise}
     */
    self.getWebaulaHtml = function(contents, moduleId) {
        var indexUrl,
            paths = {},
            promise;
        ...
        angular.forEach(contents, function(content) {
            ...
            if (self._isMainPage(content)) {
                // This seems to be the most reliable way to spot the index webaula.
                indexUrl = url;
            } else {
        ...
        promise = (function() {
            ...
            if (!indexUrl) {
                ...
                $log.debug('Could not locate the index webaula');
                return $q.reject();
    ...
    /**
     * Returns whether the file is the main webaula of the module.
     *
     * @module mm.addons.mod_webaula
     * @ngdoc method
    ...
    self._isMainPage = function(file) {
        var filename = file.filename || undefined,
            ...
            url = '/mod_webaula/content/index.html',
    ...
    /**
     * Check if webaula plugin is enabled in a certain site.
     *
     * @module mm.addons.mod_webaula
     * @ngdoc method
    ...
    /**
     * Report a webaula as being viewed.
     *
     * @module mm.addons.mod_webaula
     * @ngdoc method
    ...
    self.logView = function(id) {
        if (id) {
            ...
            return $mmSite.write('mod_webaula_view_webaula', params);
        }
        return $q.reject();
    };
